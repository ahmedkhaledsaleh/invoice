                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name"
                               class="form-control {{ $errors->has('name') ? 'is-invalid' :  'form-control-solid'  }}   "
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email"
                               class="form-control {{ $errors->has('email') ? 'is-invalid' :  'form-control-solid'  }}   "
                    ...
                    <div class="form-group">
                        ...
                        <select name="roles" class="form-control form-control-solid">
                            ...
                            @foreach($roles as $role)
                                <option
                                    {{$urole == $role->id ? 'selected' : ''}} value="{{$role->id}}">{{$role->name}}</option>
                            @endforeach
                        </select>
                    </div>
